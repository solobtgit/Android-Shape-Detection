 ...
 */
public class DetectShape extends Activity implements CvCameraViewListener2 {
    /**
     * class name for debugging with logcat
     */
    private static final String TAG = DetectShape.class.getName();
    /**
     * the camera view
     */
    ...
    private String getSelectedShapes;
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        getSelectedShapes = getIntent().getStringExtra("SELECTED_SHAPE");
        ...
        for (MatOfPoint cnt : contours) {
            ...
            Log.d("vertices", "vertices:" + numberVertices);
                ...
                if (DISPLAY_IMAGES) {
                    ...
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            resultIntent = new Intent(getApplicationContext(), ShowResultPage.class);
                            resultIntent.putExtra("SELECTED_SHAPE","Triangle");
                    ...
                    if (DISPLAY_IMAGES) {
                        ...
                        new Timer().schedule(new TimerTask() {
                            ...
                            public void run() {
                                ...
                                resultIntent = new Intent(getApplicationContext(), ShowResultPage.class);
                                resultIntent.putExtra("SELECTED_SHAPE","Rectangle");
                                startActivityForResult(resultIntent, 0);
                            }
                        }, 2000);
                    ...
                    if (!DISPLAY_IMAGES) {
                        ...
                        new Timer().schedule(new TimerTask() {
                            ...
                            public void run() {
                                ...
                                resultIntent = new Intent(getApplicationContext(), ShowResultPage.class);
                                resultIntent.putExtra("SELECTED_SHAPE","Circle");
                                startActivityForResult(resultIntent, 0);
                            }
                        }, 2000);
